...
class Pessoa{
    ...
    */
    ...
    public function inserir(){
        $sql = "INSERT INTO pessoa (`nome`,`endereco`,`bairro`,`cep`,`cidade`,`estado`,`telefone`,`celular`) VALUES(?,?,?,?,?,?,?,?)"; //Prepara a inserção de dados
        $stmt = $this->conexao->getConexao()->prepare($sql); //Prepara a conexão com o banco
        ...
        return $stmt->execute(); //Retorna resultado da execução
    }
